...
DATA_PATH = "datasets/processed/processed_tower_utilization.csv"
MODEL_DIR = "ai_engine/models/"
REPORTS_DIR = "reports/"
MODEL_PATH = os.path.join(MODEL_DIR, "congestion.pkl")
SCALER_PATH = os.path.join(MODEL_DIR, "congestion_scaler.pkl")
METADATA_PATH = os.path.join(MODEL_DIR, "congestion_metadata.json")
...
def main():
    ...
    # 3. Train Test Split
    logging.info("Splitting dataset into 80/20 train/test sets with stratification...")
    ...
    # 7. Evaluate Model
    metrics = evaluate_classifier(model, X_test_scaled, y_test, model_name="congestion", reports_dir=REPORTS_DIR)
    ...
    # 9. Save Metadata
    metadata = {
        "Model Name": "Congestion Prediction Model",
